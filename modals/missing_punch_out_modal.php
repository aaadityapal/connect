...
function openMissingPunchOutModal(date) {
    openMissingPunchOutModalInternal(date);
}

// Function to open the missing punch out modal with a specific date (internal)
function openMissingPunchOutModalInternal(date) {
    ...
    isMissingPunchOutSubmitting = false;
...
let isMissingPunchOutSubmitting = false;
...
function initMissingPunchOutModal() {
    ...
    if (submitButton) {
        submitButton.addEventListener('click', function(event) {
            ...
            if (isMissingPunchOutSubmitting) {
                console.log('Submission already in progress, ignoring duplicate click');
                return;
            }
            
            // Set submitting flag
            isMissingPunchOutSubmitting = true;
