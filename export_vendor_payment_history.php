 ...
 * Generates a detailed Excel report showing all payments made to a specific vendor
 */
...
// Get vendor ID and name from query parameters
$vendor_id = intval($_GET['vendor_id'] ?? 0);
$vendor_name = $_GET['vendor_name'] ?? 'Vendor';
...
try {
    ...
    // Fetch all payment records for this vendor
    $payments_query = "
        SELECT 
            m.payment_entry_id,
        ...
        WHERE l.recipient_id_reference = :vendor_id
        AND l.recipient_type_category NOT IN ('Permanent', 'Temporary', 'Vendor')
        ORDER BY m.payment_date_logged DESC, m.payment_entry_id DESC
    ";

    $payments_stmt = $pdo->prepare($payments_query);
    $payments_stmt->execute([':vendor_id' => $vendor_id]);
    ...
    $filename = 'Vendor_Payment_History_' . $vendor['vendor_unique_code'] . '_' . date('Y-m-d') . '.xls';
    ...
    echo '<Interior ss:Color="#2a4365" ss:Pattern="Solid"/>';
    ...
    echo '<Font ss:Bold="1" ss:Size="16" ss:Color="#2a4365"/>';
    echo '<Alignment ss:Horizontal="Center" ss:Vertical="Center"/>';
    echo '</Style>';
    ...
    echo '<Font ss:Bold="1" ss:Size="12" ss:Color="#FFFFFF"/>';
    echo '<Interior ss:Color="#38a169" ss:Pattern="Solid"/>';
    echo '<Alignment ss:Horizontal="Right" ss:Vertical="Center"/>';
    echo '<NumberFormat ss:Format="₹#,##0.00"/>';
    echo '<Borders>';
    ...
    echo '<Data ss:Type="String">VENDOR PAYMENT HISTORY REPORT</Data>';
    echo '</Cell>';
    echo '</Row>';
    ...
    // Vendor details
    echo '<Row>';
    echo '<Cell ss:StyleID="SubtitleStyle"><Data ss:Type="String">Vendor Code:</Data></Cell>';
    echo '<Cell ss:StyleID="DataStyle"><Data ss:Type="String">' . htmlspecialchars($vendor['vendor_unique_code']) . '</Data></Cell>';
    echo '<Cell/>';
    echo '<Cell ss:StyleID="SubtitleStyle"><Data ss:Type="String">Vendor Name:</Data></Cell>';
    echo '<Cell ss:MergeAcross="3" ss:StyleID="DataStyle"><Data ss:Type="String">' . htmlspecialchars($vendor['vendor_full_name']) . '</Data></Cell>';
    echo '</Row>';

    echo '<Row>';
    echo '<Cell ss:StyleID="SubtitleStyle"><Data ss:Type="String">Email:</Data></Cell>';
    echo '<Cell ss:StyleID="DataStyle"><Data ss:Type="String">' . htmlspecialchars($vendor['vendor_email_address']) . '</Data></Cell>';
    echo '<Cell/>';
    echo '<Cell ss:StyleID="SubtitleStyle"><Data ss:Type="String">Phone:</Data></Cell>';
    echo '<Cell ss:StyleID="DataStyle"><Data ss:Type="String">' . htmlspecialchars($vendor['vendor_phone_primary']) . '</Data></Cell>';
    echo '</Row>';

    echo '<Row>';
    echo '<Cell ss:StyleID="SubtitleStyle"><Data ss:Type="String">Category:</Data></Cell>';
    echo '<Cell ss:StyleID="DataStyle"><Data ss:Type="String">' . htmlspecialchars($vendor['vendor_type_category']) . '</Data></Cell>';
    echo '<Cell/>';
    echo '<Cell ss:StyleID="SubtitleStyle"><Data ss:Type="String">Status:</Data></Cell>';
    echo '<Cell ss:StyleID="DataStyle"><Data ss:Type="String">' . htmlspecialchars(strtoupper($vendor['vendor_status'])) . '</Data></Cell>';
    echo '</Row>';
    ...
    if (count($payments) > 0) {
        ...
        echo '<Data ss:Type="String">No payment records found for this vendor</Data>';
        echo '</Cell>';
        echo '</Row>';
    }
    ...
    error_log('Export Vendor Payment History Error: ' . $e->getMessage());
