...
<div class="left-panel" id="leftPanel">
    ...
    <!-- Main Navigation -->
    <div class="menu-item <?php echo basename($_SERVER['PHP_SELF']) == 'site_supervisor_dashboard.php' ? 'active' : ''; ?>"
        onclick="window.location.href='site_supervisor_dashboard.php'">
    ...
    <div class="menu-item <?php echo basename($_SERVER['PHP_SELF']) == 'site_planner.php' ? 'active' : ''; ?>"
        onclick="window.location.href='site_planner.php'">
        <i class="fas fa-clipboard-check"></i>
        <span class="menu-text">Site Planner</span>
    </div>

    <div class="menu-item <?php echo basename($_SERVER['PHP_SELF']) == 'site_issues.php' ? 'active' : ''; ?>"
        onclick="window.location.href='site_issues.php'">
    ...
    <div class="menu-item <?php echo basename($_SERVER['PHP_SELF']) == 'worker_attendance.php' ? 'active' : ''; ?>"
        onclick="window.location.href='worker_attendance.php'">
        <i class="fas fa-user-clock"></i>
        <span class="menu-text">Attendance</span>
    </div>

    <div class="menu-item <?php echo basename($_SERVER['PHP_SELF']) == 'worker_assignment.php' ? 'active' : ''; ?>"
        onclick="window.location.href='worker_assignment.php'">
        <i class="fas fa-tasks"></i>
        <span class="menu-text">Task Assignment</span>
    </div>

    <div class="menu-item <?php echo basename($_SERVER['PHP_SELF']) == 'worker_performance.php' ? 'active' : ''; ?>"
        onclick="window.location.href='worker_performance.php'">
    ...
    <div class="menu-item <?php echo basename($_SERVER['PHP_SELF']) == 'materials_inventory.php' ? 'active' : ''; ?>"
        onclick="window.location.href='materials_inventory.php'">
    ...
    <div class="menu-item <?php echo basename($_SERVER['PHP_SELF']) == 'view_travel_expenses.php' ? 'active' : ''; ?>"
        onclick="window.location.href='view_travel_expenses.php'">
        <i class="fas fa-file-invoice-dollar"></i>
        <span class="menu-text">Travel Expenses</span>
    </div>

    <div class="menu-item <?php echo basename($_SERVER['PHP_SELF']) == 'attendance_visualizer.php' ? 'active' : ''; ?>"
        onclick="window.location.href='attendance_visualizer.php'">
        <i class="fas fa-user-clock"></i>
        <span class="menu-text">Attendance Reports</span>
    </div>

    <div class="menu-item <?php echo basename($_SERVER['PHP_SELF']) == 'site_supervisors_overtime.php' ? 'active' : ''; ?>"
        onclick="window.location.href='site_supervisors_overtime.php'">
    ...
    <div class="menu-item <?php echo basename($_SERVER['PHP_SELF']) == 'site_supervisor_profile.php' ? 'active' : ''; ?>"
        onclick="window.location.href='site_supervisor_profile.php'">
