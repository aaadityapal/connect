...
<head>
    ...
    <title>Overtime Approval Mapping | Connect</title>
    ...
    <style>
        ...
        .search-box input:focus { border-color: #f97316; background: #ffffff; }
        ...
        <main class="main-content" style="flex: 1; background: #f8fafc; min-height: 100vh;">
            <div class="mapping-container">
                <div class="page-header">
                    <h1>Overtime Approval Matrix</h1>
                    <p>Assign employees to their respective team managers to automate overtime approval workflow.</p>
                </div>
                ...
                <div id="managerGrid" class="manager-grid">
                    ...
                    <div class="loading-container">
                        ...
                        <p>Synchronizing roster structure...</p>
                    </div>
                </div>
            </div>
        </main>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            async function loadData() {
                try {
                    const res = await fetch('api/fetch_overtime_mapping.php');
            ...
            function renderManagers() {
                ...
                if (managers.length === 0) {
                    grid.innerHTML = '<div class="loading-container"><i data-lucide="info" style="margin-bottom:1rem;"></i><p>No users with Manager permissions found.</p></div>';
                    lucide.createIcons();
                    return;
                }
            ...
            window.saveMapping = async (managerId, btn) => {
                ...
                try {
                    const res = await fetch('api/update_overtime_mapping.php', {
                        method: 'POST',
