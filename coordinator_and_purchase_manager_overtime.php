...
<body class="bg-gray-100">
                        ...
                        <?php if (!empty($overtime_data)): ?>
                            ...
                            <tr id="row-<?php echo $index + 1; ?>" data-attendance-id="<?php echo isset($row['attendance_id']) ? $row['attendance_id'] : ($index + 1); ?>" data-overtime-description="<?php echo htmlspecialchars($row['overtime_description'] ?? ''); ?>" class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2 action-buttons">
                                    ...
                                    <button class="<?php echo $edit_button_class; ?>" data-action="edit" data-row-id="<?php echo $index + 1; ?>" title="<?php echo $edit_button_title; ?>" <?php echo $edit_button_disabled; ?>>
                                        <svg class="w-5 h-5 <?php echo ($has_valid_overtime_request && !$is_edit_disabled) ? 'text-yellow-600 hover:text-yellow-800' : 'text-gray-400'; ?>" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                        </svg>
                                    </button>
                                    <button class="<?php echo $send_button_class; ?>" data-action="send" data-row-id="<?php echo $index + 1; ?>" title="<?php echo $send_button_title; ?>" <?php echo $send_button_disabled; ?>>
                                    ...
                                    <button class="<?php echo $resubmit_button_class; ?>" data-action="resubmit" data-row-id="<?php echo $index + 1; ?>" title="<?php echo $resubmit_button_title; ?>" <?php echo $resubmit_button_disabled; ?>>
                                        <svg class="w-5 h-5 <?php echo $is_resubmit_disabled ? 'text-gray-400' : 'text-purple-600 hover:text-purple-800'; ?>" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    -->
    <div id="delete-overtime-modal" class="fixed inset-0 bg-gray-600 bg-opacity-50 h-full w-full flex items-center justify-center p-4 hidden visibility-hidden opacity-0 z-50">
        <div class="bg-white rounded-lg shadow-xl w-full max-w-md transform transition-all scale-95 opacity-0" id="delete-modal-content">
            <div class="border-b border-gray-200 px-6 py-4 flex justify-between items-center bg-red-50">
                <h3 class="text-lg font-medium leading-6 text-gray-900 flex items-center">
                    <svg class="h-5 w-5 text-red-600 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="px-6 py-4">
                ...
                <div class="space-y-4">
                    ...
                    <div class="border-b border-gray-100 pb-2">
                        <div class="flex items-start mb-1">
                            <svg class="h-4 w-4 text-red-500 mr-2 mt-0.5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                            <span class="text-sm font-medium text-gray-500">Work Report</span>
                        </div>
            ...
            <div class="bg-gray-50 px-6 py-3 rounded-b-lg">
                <div class="flex justify-end space-x-3">
                    <button id="delete-modal-cancel-btn" type="button" class="bg-white px-4 py-2 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 flex items-center">
                        <svg class="h-4 w-4 mr-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                        </svg>
                        Cancel
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function handleFilter() {
                ...
                // Fetch data via AJAX
                fetch(`fetch_overtime_data.php?month=${month}&year=${year}&user=<?php echo $user_id; ?>`)
                    ...
                    data.forEach((row, index) => {
                        ...
                        tr.innerHTML = `
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 max-w-xs truncate overtime-report-cell" data-full-text="${row.overtime_report || ''}" title="${row.overtime_report || 'System deployment and testing'}">
                                ${truncateText(row.overtime_report || 'System deployment and testing', 5)}
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
