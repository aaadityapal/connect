...
try {
    // Get performance data for the last 6 months for selected user
    $months = [];
    $efficiency = [];
    $completion = [];
    ...
    for ($i = 5; $i >= 0; $i--) {
        ...
        // Get efficiency for this month for selected user
        ...
        // Get completion rate for this month (tasks assigned vs completed) for selected user
    ...
    // Get task distribution data for selected user
