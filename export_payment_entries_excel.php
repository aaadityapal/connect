...
try {
    ...
    foreach ($payments as $index => $payment) {
        ...
        $html .= '<table>';
        $html .= '<tr>';
        $html .= '<td colspan="4" class="payment-main-header">Payment Entry #' . $paymentId . ' - ' . htmlspecialchars($payment['project_name_reference']) . '</td>';
        $html .= '</tr>';
        
        $html .= '<tr>';
        $html .= '<td class="payment-data"><strong>Project Type:</strong> ' . htmlspecialchars($payment['project_type_category']) . '</td>';
        ...
        $html .= '<td class="payment-data"><strong>Authorized By:</strong> ' . htmlspecialchars($payment['authorized_by'] ?? 'N/A') . '</td>';
