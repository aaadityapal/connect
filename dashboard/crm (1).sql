...
-- Procedures
--
CREATE PROCEDURE `sp_apply_leave` (IN `p_user_id` INT, IN `p_leave_type_id` INT, IN `p_start_date` DATE, IN `p_end_date` DATE, IN `p_reason` TEXT, IN `p_half_day` BOOLEAN)   BEGIN
    INSERT INTO leaves (
        user_id, 
        leave_type_id, 
        start_date, 
...
CREATE PROCEDURE `sp_update_leave_status` (IN `p_leave_id` INT, IN `p_status` ENUM('pending','approved','rejected'), IN `p_comments` TEXT, IN `p_modified_by` INT)   BEGIN
...
(2, 'Sick Leave', 'Medical and health related leave (6 days per year)', 6, 0, 1, '#F44336', 'active', NULL, '2024-12-16 12:59:41', '2025-02-12 11:08:55'),
...
(13, 'Unpaid Leave', 'Leave without pay', 0, 0, 0, '#FF4D4D', 'active', NULL, '2025-02-12 12:00:18', '2025-02-12 12:00:18');
...
(15, 21, 'leave_action', 40, 'Your leave request from 12 Feb 2025 to 13 Feb 2025 has been approved by the manager.', 'unread', '2025-02-12 09:32:13');
...
INSERT INTO `office_holidays` (`id`, `holiday_date`, `holiday_name`, `created_at`, `updated_at`) VALUES
(1, '2025-01-01', 'New Year', '2025-02-10 12:40:25', '2025-02-10 12:40:25'),
(2, '2025-01-26', 'Republic Day', '2025-02-10 12:40:25', '2025-02-10 12:40:25'),
(3, '2025-02-26', 'Maha Shivaratri', '2025-02-10 12:40:25', '2025-02-10 12:40:25'),
(4, '2025-03-14', 'Holi', '2025-02-10 12:40:25', '2025-02-10 12:40:25'),
(5, '2025-04-06', 'Ram Navmi', '2025-02-10 12:40:25', '2025-02-10 12:40:25'),
(6, '2025-08-09', 'Raksha Bandhan', '2025-02-10 12:40:25', '2025-02-10 12:40:25'),
(7, '2025-08-15', 'Independence Day', '2025-02-10 12:40:25', '2025-02-10 12:40:25'),
(8, '2025-10-02', 'Gandhi Jayanti', '2025-02-10 12:40:25', '2025-02-10 12:40:25'),
(9, '2025-10-02', 'Dussehra', '2025-02-10 12:40:25', '2025-02-10 12:40:25'),
(10, '2025-10-21', 'Diwali', '2025-02-10 12:40:25', '2025-02-10 12:40:25'),
(11, '2025-10-23', 'Bhai Dooj', '2025-02-10 12:40:25', '2025-02-10 12:40:25'),
(12, '2025-12-25', 'Christmas', '2025-02-10 12:40:25', '2025-02-10 12:40:25');
...
CREATE TABLE `project_stages` (
  ...
  `start_date` datetime NOT NULL,
  `end_date` datetime NOT NULL,
  `status` enum('not_started','pending','in_progress','in_review','completed','on_hold','cancelled','blocked','freezed','sent_to_client') NOT NULL DEFAULT 'not_started',
  `created_at` datetime NOT NULL,
  `updated_at` datetime DEFAULT NULL,
  `deleted_at` datetime DEFAULT NULL,
  `updated_by` int(11) DEFAULT NULL
...
INSERT INTO `users` (`id`, `username`, `position`, `email`, `employee_id`, `phone_number`, `designation`, `department`, `password`, `role`, `unique_id`, `reporting_manager`, `created_at`, `updated_at`, `deleted_at`, `status`, `last_login`, `profile_image`, `address`, `emergency_contact`, `joining_date`, `modified_at`, `city`, `state`, `country`, `postal_code`, `emergency_contact_name`, `emergency_contact_phone`, `phone`, `dob`, `profile_picture`, `bio`, `gender`, `marital_status`, `nationality`, `languages`, `social_media`, `skills`, `interests`, `blood_group`, `education`, `work_experience`, `bank_details`, `shift_id`, `documents`, `work_experiences`, `education_background`, `base_salary`, `allowances`, `deductions`, `overtime_rate`) VALUES
(1, 'Aditya Pal', 'Principal Architect', 'aaadityapal69@gmail.com', 'EMP0001', NULL, 'IT Support', NULL, '$2y$10$TkB2JPXzRLntod.z0/118ecgqbgYey8Vy7zbJb0ityfZJ8/27yiU.', 'admin', 'ADM001', 'Sr. Manager (Studio)', '2024-12-16 12:38:03', '2025-02-10 10:54:26', NULL, 'Active', '2024-12-27 12:33:00', NULL, 'dsa', NULL, '2025-01-11', '2025-02-10 10:54:26', '', '', '', '', '', '', '7224864553', '2001-10-24', NULL, NULL, 'male', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '{\"account_holder\":\"\",\"bank_name\":\"\",\"account_number\":\"\",\"ifsc_code\":\"\",\"branch_name\":\"\",\"account_type\":\"savings\"}', NULL, '{\"aadhar\":{\"filename\":\"1_aadhar_67826cd3662c5.pdf\",\"original_name\":\"RACHANA PAL_CV (1).pdf\",\"uploaded_at\":\"2025-01-11 18:36:27\"}}', NULL, NULL, 0.00, NULL, NULL, 0.00),
(2, 'Gunjan Sehgal', 'HR', 'hr.architectshive@gmail.com', NULL, NULL, 'Human Resources', NULL, '$2y$10$IJ14sW0I9TEJYaVCxf9.yuFZZlET3kH8vwpQUGkNg5cUu0FQa7GRG', 'HR', 'HR001', 'Sr. Manager (Studio)', '2024-12-16 13:07:28', '2025-02-13 06:10:20', NULL, 'Active', '2025-02-13 11:40:20', '676e5805148ee.png', '', NULL, '2025-01-15', '2025-02-13 06:10:20', '', '', '', '', '', '', '7224864553', '2024-12-17', 'uploads/profile_pictures/67a3557adbd86_default-avatar.png', '', 'female', '', '', '', 'null', '', '', '', 'null', 'null', 'null', NULL, NULL, NULL, NULL, 0.00, NULL, NULL, 0.00),
(3, 'Yojna Sharma', NULL, 'yojna.sharma@architectshive.com', NULL, NULL, '', NULL, '$2y$10$rdsbXtR/qSCAJHC0rlbMYOCcMdaq6U5NHmV2FeKemXUXejGXUap1e', 'Senior Manager (Studio)', 'SMS001', '', '2024-12-17 06:41:36', '2025-02-12 15:16:18', NULL, 'Active', '2025-02-12 20:46:18', NULL, NULL, NULL, NULL, '2025-02-12 15:16:18', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0000-00-00', 'uploads/profile_pictures/67939abcd8f72_wallpaperflare.com_wallpaper (1).jpg', '', '', 'married', 'Indian', '', NULL, '', '', 'A+', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, NULL, 0.00),
(7, 'Preeti Choudhary', 'Junior Architect', 'arch.preeti@gmail.com', NULL, NULL, 'Architecture Design', NULL, '$2y$10$pE9NEK7/IbfSc.m2o7f0.eSbR8/YF6rMPjqecM9agUSyA28f7T1Lu', 'Working Team', 'WT001', 'Sr. Manager (Studio)', '2024-12-17 09:04:26', '2025-02-12 12:15:10', NULL, 'Active', '2025-02-05 13:20:09', NULL, NULL, NULL, '2024-04-26', '2025-02-12 12:15:10', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1999-08-05', NULL, '', 'female', '', '', '', NULL, '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, NULL, 0.00),
(11, 'Rachana Pal', NULL, 'arch.rachanapal@gmail.com', NULL, NULL, '', NULL, '$2y$10$fcFm76vgXeXSCu.52PhM9OGaCZzkwOYjkLxxZqLx0Q0QKMUR1T5Yi', 'Senior Manager (Studio)', 'SMS002', '', '2024-12-18 06:50:47', '2025-02-10 10:54:26', NULL, 'Active', '2025-01-16 17:28:37', NULL, NULL, NULL, NULL, '2025-02-10 10:54:26', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, NULL, 0.00),
(15, 'Manish Prajapati', 'Junior Architect', 'manish@architectshive.com', NULL, NULL, 'Interior Design', NULL, '$2y$10$PNldyXlZaPlzXxYRYr6Z9OZa/vo/y1fRMDru6ESac77CLZXbTvjca', 'Design Team', 'DT001', 'Sr. Manager (Studio)', '2024-12-18 07:45:15', '2025-02-12 06:12:49', NULL, 'Active', '2025-02-10 13:09:51', NULL, NULL, NULL, NULL, '2025-02-12 06:12:49', NULL, NULL, NULL, NULL, NULL, NULL, '8855223322', '2001-02-22', 'uploads/profile_pictures/679c6707b6683_photo_2024-12-31_16-34-42.jpg', '', 'male', '', '', '', '{\"linkedin\":\"\",\"twitter\":\"\",\"facebook\":\"\",\"instagram\":\"\",\"github\":\"\",\"youtube\":\"\"}', '', '', '', '{\"highest_degree\":\"\",\"institution\":\"\",\"field_of_study\":\"\",\"graduation_year\":\"\"}', '{\"current_company\":\"\",\"job_title\":\"\",\"experience_years\":\"\",\"responsibilities\":\"\"}', '{\"bank_name\":\"\",\"account_holder\":\"\",\"account_number\":\"\",\"ifsc_code\":\"\"}', 4, '[]', NULL, NULL, 14000.00, NULL, NULL, 67.63),
(21, 'Aditya Kumar Pal', 'Office Manager', 'aaadityapal69@icloud.com', NULL, NULL, 'IT Support', NULL, '$2y$10$9iAXnlBQEP0rpiW82X2jfO.7F9A7VpHzPmt/2C2L/2sxZDwjuQcVa', 'Design Team', 'DT002', 'Sr. Manager (Studio)', '2024-12-18 09:29:49', '2025-02-11 14:07:18', NULL, 'Active', '2025-02-10 12:33:06', NULL, 'F-48 Street Number 16, Madhu Vihar', NULL, '2025-01-01', '2025-02-11 14:07:18', 'Delhi NCR', 'Delhi', 'India', '110092', 'Aditya Pal', '07224864553', '1122334455', '2001-10-24', 'uploads/profile_pictures/67837303da8d8_photo_2024-12-31_16-34-42.jpg', '', 'male', 'single', 'Indian', 'English', '{\"linkedin\":\"\",\"twitter\":\"\",\"facebook\":\"\",\"instagram\":\"\",\"github\":\"\",\"youtube\":\"\"}', '', '', 'O+', '{\"highest_degree\":\"high_school\",\"institution\":\"\",\"field_of_study\":\"\",\"graduation_year\":\"\"}', '{\"current_company\":\"ArchitectsHive\",\"job_title\":\"Senior Manager\",\"experience_years\":\"2\",\"responsibilities\":\"Working there as a senior manager for 2 years\\n\"}', '{\"account_holder\":\"Aditya Kumar Pal\",\"bank_name\":\"State Bank Of India\",\"account_number\":\"6969696969\",\"ifsc_code\":\"SBIN0003965\",\"branch_name\":\"hola amigo\",\"account_type\":\"savings\"}', 4, '[{\"type\":\"aadhar\",\"filename\":\"RACHANA PAL_CV.pdf\",\"file_path\":\"uploads\\/documents\\/67837548c5957_RACHANA PAL_CV.pdf\",\"upload_date\":\"2025-01-12 13:24:48\"},{\"type\":\"pan\",\"filename\":\"Agreement_2024-12-02_100746.pdf\",\"file_path\":\"uploads\\/documents\\/67837e6651576_Agreement_2024-12-02_100746.pdf\",\"upload_date\":\"2025-01-12 14:03:42\"},{\"type\":\"passport\",\"filename\":\"salary_report_2024-11 (2).pdf\",\"file_path\":\"uploads\\/documents\\/678381c3b089b_salary_report_2024-11 (2).pdf\",\"upload_date\":\"2025-01-12 14:18:03\"}]', '[{\"current_company\":\"ArchitectsHive\",\"job_title\":\"Senior IT manager\",\"experience_years\":\"2\",\"responsibilities\":\"Managing all the technical Stuff and work as a Full stack Developer\\r\\n \\r\\n\"}]', '[]', 15000.00, '{\"hra\":\"0\",\"da\":\"0\",\"ta\":\"0\",\"medical\":\"0\"}', '{\"pf\":\"0\",\"tax\":\"0\",\"insurance\":\"0\"}', 72.46),
(22, 'Meenakshi Kumari', NULL, 'arch.meenakshi@gmail.com', NULL, NULL, '', NULL, '$2y$10$8dbf3AO.fMPkLXfW9EUDNOCjvP9OcaSuQxYUxpP62RzEd4FRSkjN.', 'Design Team', 'DT003', 'Sr. Manager (Studio)', '2025-02-05 07:45:01', '2025-02-10 10:54:26', NULL, 'Active', '2025-02-05 13:15:01', NULL, NULL, NULL, NULL, '2025-02-10 10:54:26', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, NULL, 0.00),
(23, 'Mohit Verma', NULL, 'arch.mohit@gmail.com', NULL, NULL, '', NULL, '$2y$10$orJE4O6qA6z4YIu.GDcWFeicE2WBvd5tHtDsGJuVGUX1d2alQxj2m', 'Studio Trainees', 'STR001', 'Sr. Manager (Studio)', '2025-02-05 07:46:33', '2025-02-10 10:54:26', NULL, 'Active', '2025-02-05 13:16:33', NULL, NULL, NULL, NULL, '2025-02-10 10:54:26', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, NULL, 0.00),
(24, 'Devikaa Rajput', NULL, 'arch.devikaa@gmail.com', NULL, NULL, '', NULL, '$2y$10$R3W9Y6MnpS.HoeImyAVvl.6pocRh7/6r2b4GSYK0Qz4qaTPTIf8Ri', 'Design Team', 'DT004', 'Sr. Manager (Studio)', '2025-02-05 07:47:30', '2025-02-13 05:38:18', NULL, 'Active', '2025-02-05 13:17:30', NULL, NULL, NULL, NULL, '2025-02-13 05:38:18', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 15000.00, NULL, NULL, 72.46),
(25, 'Prabhat Arya', NULL, 'prabhat@architectshive.com', NULL, NULL, '', NULL, '$2y$10$G/qSSGMtU4YepzCsyRXnO.jtx1G1o1/Q12lrEeDQ88NPifhWpNaYO', 'Senior Manager (Studio)', 'SMS003', '', '2025-02-05 07:48:10', '2025-02-10 10:54:26', NULL, 'Active', '2025-02-05 13:18:21', NULL, NULL, NULL, NULL, '2025-02-10 10:54:26', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, NULL, 0.00),
(26, 'Sarvesh Pathri', NULL, 'arch.sarvesh@gmail.com', NULL, NULL, '', NULL, '$2y$10$NzBS2WAl3wpRAUDElDdIieYntORhoHbgFF5pjvwvUlNxd/LiLs90O', 'Studio Trainees', 'STR002', 'Sr. Manager (Studio)', '2025-02-05 07:51:18', '2025-02-10 10:54:26', NULL, 'Active', '2025-02-05 13:21:18', NULL, NULL, NULL, NULL, '2025-02-10 10:54:26', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, NULL, 0.00);
...
CREATE TABLE `user_leave_balance` (
  ...
  `used_days` decimal(10,2) DEFAULT 0.00,
  `carried_forward_days` decimal(10,2) DEFAULT 0.00,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `modified_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `salary_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7666;
...
--
-- Constraints for table `leave_bank`
--
ALTER TABLE `leave_bank`
  ADD CONSTRAINT `leave_bank_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `leave_bank_ibfk_2` FOREIGN KEY (`leave_type_id`) REFERENCES `leave_types` (`id`);
...
--
-- Constraints for table `user_leave_balance`
--
ALTER TABLE `user_leave_balance`
  ADD CONSTRAINT `user_leave_balance_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `user_leave_balance_ibfk_2` FOREIGN KEY (`leave_type_id`) REFERENCES `leave_types` (`id`);
