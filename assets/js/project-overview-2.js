        ...
        try {
            ...
            if (data.success) {
                ...
                this.userProjects = rawProjects.filter(p => {
                    ...
                    // Process stages - ensure hierarchical deletion
                    if (p.stages && Array.isArray(p.stages)) {
                        p.stages = p.stages.filter(stage => {
                            // Check if stage is deleted
                            ...
                            // If stage is deleted, filter it out
                            if (isStageSoftDeleted || stageDeletedFlag) {
                                return false;
                            }
                            
                            // Process substages - ensure hierarchical deletion
                            if (stage.substages && Array.isArray(stage.substages)) {
                                stage.substages = stage.substages.filter(substage => {
                                    // Check if substage is deleted
                                    ...
                                    // If substage is deleted, filter it out
